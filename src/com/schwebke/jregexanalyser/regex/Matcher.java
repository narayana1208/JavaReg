...
/*
 * $Id: Matcher.java 159 2010-08-07 10:40:48Z kai $
 */
...
public final class Matcher implements MatchResult 
{
    ...
    {
        statistics.add(new Statistics(this.from, this.to, from, text));
        this.hitEnd = false;
    ...
    public TableModel getTraceAsTable() 
    {
        return Statistics.getTraceAsTable(statistics);
    }
}
