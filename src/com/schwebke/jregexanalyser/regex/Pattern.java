...
/*
 * $Id: Pattern.java 406 2010-12-26 09:12:08Z kai $
 */
...
public final class Pattern implements java.io.Serializable
{
    ...
    public TreeNode getFindPatternTree(Map<Object, DefaultMutableTreeNode> nodeMap) {
        return Statistics.getPatternAsTree(root, nodeMap);
    }

    public TreeNode getMatchPatternTree(Map<Object, DefaultMutableTreeNode> nodeMap) {
        return Statistics.getPatternAsTree(matchRoot, nodeMap);
    }

    public String getFindPatternDot() {
        return Statistics.getPatternAsDot(root);
    }

    public String getMatchPatternDot() {
        return Statistics.getPatternAsDot(matchRoot);
    }
...
loop:   for(int x=0, offset=0; x<nCodePoints; x++, offset+=len) {
    ...
    static class Node extends Object {
        ...
        boolean match(Matcher matcher, int i, CharSequence seq) {
            Statistics s = matcher.getCurrentStatistics();
            s.incLevel();
            Statistics.MatchTest t = s.newMatchTest(this, i);
            
            boolean r = this.matchImpl(matcher, i, seq);
            ...
            if (s.getLevel() == 0) {
                if (r) {
                    s.setResult(matcher.first, matcher.last);
                }
            }
        ...
        List<Node> getChilds() {
            List<Node> c = new ArrayList<Node>(1);
            c.add(next);
            return c;
        }

        /**
         * Provide optional additional info for the Node instance.
         */
        String getInfo() {
            return null;
        }
         ...
         */
        boolean matchImpl(Matcher matcher, int i, CharSequence seq) {
            matcher.last = i;
    ...
    static class Start extends Node {
        ...
        String getInfo() {
            return String.format("minLength = %d", minLength);
        }
    }
    ...
    static final class Dollar extends Node {
        ...
        String getInfo() {
            return "multiline = "+(multiline?"true":"false");
        }
    }
    ...
    static final class SingleS extends CharProperty {
        ...
        String getInfo() {
            return String.format("c = '%c'", (char)c);
        }
    }
    ...
    static final class SingleI extends BmpCharProperty {
        ...
        String getInfo() {
            return String.format("l = '%c', u='%c'", (char)lower, (char)upper);
        }
    }
    ...
    static final class SingleU extends CharProperty {
        ...
        String getInfo() {
            return String.format("c = '%c'", (char)lower);
        }
    }
    ...
    static final class Category extends CharProperty {
        ...
        String getInfo() {
            return "typeMask = "+Integer.toBinaryString(typeMask);
        }
    }
    ...
    static final class Ctype extends BmpCharProperty {
        ...
        String getInfo() {
            return String.format("ctype = %s", ASCII.getCtype(ctype));
        }
    }
    ...
    static final class Ques extends Node {
		...
		List<Node> getChilds() {
			...
			ArrayList<Node> c = new ArrayList(2);
            c.add(atom);
            c.add(next);
            return c;
        }
    ...
    static final class Curly extends Node {
        ...
        String getInfo() {
            StringBuilder b = new StringBuilder();
            b.append(String.format("min = %d, ", cmin));
            b.append(String.format("max = %d, ", cmax));
            b.append("type = ");
            switch (type) {
                case GREEDY:
                    b.append("GREEDY");
    ...
    static final class GroupCurly extends Node {
        ...
        String getInfo() {
            ...
            b.append(String.format("min = %d, ", cmin));
            b.append(String.format("max = %d, ", cmax));
            b.append(String.format("local = %d, ", localIndex));
            b.append(String.format("group = %d, ", groupIndex));
            b.append("type = ");
            switch (type) {
                case GREEDY:
                    b.append("GREEDY");
    ...
    static final class Branch extends Node {
		...
		List<Node> getChilds() {
            @SuppressWarnings("rawtypes")
			ArrayList<Node> c = new ArrayList(2+size);
            for (Node n : atoms) {
                if (n != null) {
                    c.add(n);
                } else {
    ...
    static final class GroupHead extends Node {
        ...
        String getInfo() {
            return String.format("local = %d", localIndex);
        }
    }
    ...
    static final class GroupTail extends Node {
        ...
        String getInfo() {
            return String.format("local = %d, group = %d", localIndex, groupIndex);
        }
    }
    ...
    static class Loop extends Node {
        ...
        String getInfo() {
            return String.format("count = %d, begin = %d, min = %d, max = %d",
                    countIndex, beginIndex, cmin, cmax);
        }
    }
    ...
    static class BackRef extends Node {
        ...
        String getInfo() {
            return String.format("group = %d", groupIndex);
        }
    }
    ...
    static final class Conditional extends Node {
		...
		List<Node> getChilds() {
            @SuppressWarnings("rawtypes")
			ArrayList<Node> c = new ArrayList(4);
            c.add(cond);
            c.add(yes);
            c.add(not);
            //c.add(next);
    ...
    static class Behind extends Node {
        ...
        String getInfo() {
            return String.format("min = %d, max = %d", rmin, rmax);
        }
    }
